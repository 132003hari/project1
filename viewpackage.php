	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>VIEW PACKAGE</h3></strong>
				<?php
					require_once 'admin/connect.php';
					$query = $conn->query("SELECT * FROM `pack` ORDER BY `chargeinperson` ASC") or die(mysql_error());
				...
				?>
					...
					<div style = "float:left; margin-left:10px;">
							...
							<h4 style = "color:#00ff00;"><?php echo "chargeinperson: Php. ".$fetch['chargeinperson'].".00"?></h4>
							<br /><br /><br /><br /><br /><br />
							<a style = "margin-left:580px;" href = "add_query_reservepack.php?packageid=<?php echo $fetch['packageid']?>" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> Reserve</a>
						</div>
					</div>
				<?php
					}
