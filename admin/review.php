	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Transaction / reviews</div>
				<a class = "btn btn-success" href = "review.php"><i class = "glyphicon glyphicon-plus"></i> reviews</a>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT * FROM `rev`") or die(mysqli_error());
						while($fetch = $query->fetch_array()){
					?>	
						<tr>
					
							<td><?php echo $fetch['cusid']?></td>
							<td><?php echo $fetch['cusname']?></td>
							<td><?php echo $fetch['reviewdetails']?></td>
                            <td><?php echo $fetch['reviewdate']?></td>
