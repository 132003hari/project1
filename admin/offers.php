	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Transaction / offers</div>
				<a class = "btn btn-success" href = "add_offers.php"><i class = "glyphicon glyphicon-plus"></i> Add offers</a>
				<br />
				<br />
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$query = $conn->query("SELECT * FROM `offer`") or die(mysqli_error());
					...
					?>	
						<tr>
							...
							<td><center><a class = "btn btn-warning" href = "edit_offers.php?offerid=<?php echo $fetch['offerid']?>"><i class = "glyphicon glyphicon-edit"></i> Edit</a> <a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_offer.php?offerid=<?php echo $fetch['offerid']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></center></td>
						</tr>
					<?php
						}
					?>	
