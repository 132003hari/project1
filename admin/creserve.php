	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<a class = "btn btn-info" href = "checkin2.php"><span class = "badge"><?php echo $f_ci['total']?></span> Check In</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `ctransaction` NATURAL JOIN `guest` WHERE  `status` = 'Pending'") or die(mysqli_error());
