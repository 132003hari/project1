	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Transaction / package/ Add package</div>
				<br />
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						...
						<div class = "form-group">
							...
							<input type = "text"  class = "form-control" name = "packagedetails" />
						</div>
						<div class = "form-group">
                            <label>offers</label>
                        ...
                        <label>chargeinperson</label>
                            <input type = "number" min = "0" max = "999999999" class = "form-control" name = "chargeinperson" />
                    </div>
						
						<div class = "form-group">
							<button name = "add_package" class = "btn btn-info form-control"><i class = "glyphicon glyphicon-save"></i> Saved</button>
						</div>
					</form>
					<?php require_once 'add_query_package.php'?>
				</div>
			</div>
		</div>
	</div>
