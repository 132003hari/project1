	...
	<div style = "margin-left:40;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>CAB RESERVATION</h3></strong>
				<br />
				<?php 
					require_once 'admin/connect.php';
					$query = $conn->query("SELECT * FROM `cab` WHERE `cabid` = '$_REQUEST[cabid]'") or die(mysql_error());
				...
				<div style = "height:300px; width:800px;">
					...
					<div style = "float:left; margin-left:10px;">
						...
						<h3 style = "color:#00ff00;"><?php echo "Php. ".$fetch['tariff'].".00";?></h3>
					</div>
				</div>
				<br style = "clear:both;" />
				<div class = "well col-md-4">
					<form method = "POST" enctype = "multipart/form-data">
						...
						<div class = "form-group">
							<label>cabtype</label>
							<input type = "text" class = "form-control" name = "cabtype" value="<?php echo $fetch['cabtype']?>" required ='required'  />
						</div>
						<div class = "form-group">
				...
				<?php require_once 'add_query_viewcab.php'?>
			</div>
		</div>
	</div>
	<br />
