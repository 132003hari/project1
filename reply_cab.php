...
<html lang = "en">
	<head>
		<title>Simple Hotel Online Reservatio</title>
		<meta charset = "utf-8" />
...
<li><a href = "index.php">Homepage</a></li> |		
        ...
        <li><a href = "viewcab.php">viewcab</a></li> |
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<div class = "well col-md-4">
					...
					<br />
					<center><a href = "viewcab.php" class = "btn btn-success"><i class = "glphyicon glyphicon-check"></i> Back to reservation</a></center>
				</div>
				<div class = "col-md-4"></div>
			</div>
		</div>
